            ...
            return (
              ...
              (t.prototype.start = function () {
                ...
                window.setTimeout(function () {
                  alert("泓澄如止水，清明映人间。
游戏中，铜镜不断合成；历史中，铜镜几度浮沉。人以镜面照容，以镜背雕琢人间百态。后人以铜镜演绎、还原历史长剧的片段，探索前人广阔精神世界。
本游戏配合复旦大学文物与博物馆学系本科生策划“止水映人间——王纲怀先生捐赠铜镜展”推出，希冀游戏在陪伴您的闲暇之光之余，也能带您走进我们的展览，与我们一同体悟铜镜之美。
！");
                }, 500);
              }),
              (t.prototype.update = function (e) {
          ...
          gameEnd1: function () {
            ...
            1 == t
              ...
              ? ((this.gameOverT1.string = "\uac8c\uc784 \uc885\ub8cc"),
                (this.gameOverT2.string =
                  "\ud074\ub9ad \ud558\uc5ec \uc810\uc218 \ubcf4\uae30"))
              : ((this.gameOverT1.string = "游戏结束！复旦大学“止水映人间——王纲怀先生捐赠铜镜展”展期为2021年5月15日——9月30日，欢迎各位老师和同学前往复旦大学博物馆300号楼观展。"),
                (this.gameOverT2.string = "点击查看分数")),
                          ...
                          .call(function () {
                            ...
                            if (isFirstContact) {
                              window.setTimeout(function () {
                                alert("重圈直纹镜
时代：商代
这枚铜镜中，放射状纹与草原聚落或首领墓葬的结构非常相像，因此可能是一种源自草原观念的纹饰。
");
                                isFirstContact = false;
                              }, 500);
                            }
                            if (isFirst[o.fruitNumber]) {
                              window.setTimeout(function () {
                                switch (o.fruitNumber) {
                                  case 0:
                                    alert("花叶文镜
时代：战国
战国时期，随着青铜工艺的发展，铜镜的镜背纹饰逐渐丰富。此枚铜镜的纹饰为典型的花叶纹。
");
                                    isFirst[0] = false;
                                    break;
                                  case 1:
                                    alert("五山镜
时代：战国
这枚五山镜，饰为五个凹弧面山字，地纹为羽翅纹。山字纹镜是战国时期楚镜中最具代表性的类型之一，以山字纹为主体，根据山字的数目，分为三山镜、四山镜、五山镜、六山镜四种。
");
                                    isFirst[1] = false;
                                    break;
                                  case 2:
                                    alert("上君卿铭连弧镜
时代：西汉
“上”通“尚”。这枚铜镜的铭文内容“美宜之，上君卿，乐富昌，寿未央”，鼓励女性梳妆打扮以取悦君子、大夫。
");
                                    isFirst[2] = false;
                                    break;
                                  case 3:
                                    alert("君来何伤铭镜
时代：西汉
这枚铜镜铜镜的铭文内容为“君来何伤，慎毋相忘”，为离别的祝愿，希望对方与自己不要相忘于江湖。
");
                                    isFirst[3] = false;
                                    break;
                                  case 4:
                                    alert("从酒铭博局草叶镜
时代：西汉
这枚西汉从酒铭博局草叶镜饰有龙纹钮，方宽弦纹钮座。钮座外有汉篆字体的8字铭文：“从酒高堂，投薄至明”，饮酒投博，酣畅淋漓之感尽显其中。
");
                                    isFirst[4] = false;
                                    break;
                                  case 5:
                                    alert("盘龙镜
时代：唐代
这枚铜镜整体造型如葵花，这是隋唐时期的创新。镜中间有圆形的镜钮，而旁边正有一条龙对着镜钮张大嘴巴，镜钮竟还象征着龙珠，盘龙穿身于五朵祥云。
");
                                    isFirst[5] = false;
                                    break;
                                  case 6:
                                    alert("仙人鹤寿镜
时代：金
仙人鹤寿镜，主纹为仙人鹤寿，右侧梅树下有位长髯老者，旁立一女子或侍童。前有一鹤。左侧房门虚掩，麻姑手捧一龟，迈步向前。知龟鹤之遐寿，故效其导引以增年，龟纹、鹤纹均有长寿寓意，麻姑则是道教传说中的寿仙娘娘，古人对长寿的渴望在这镜背上可见一斑。
");
                                    isFirst[6] = false;
                                    break;
                                  case 7:
                                    alert("喜上眉梢纹景泰蓝工艺镜
时代：明清
这枚明清之际的铜镜镜背饰太湖石、兰花与梅花，两只喜鹊立于梅枝上，寓意“喜上眉梢”。镜名中的景泰蓝，又称“珐蓝”，是一种特殊工艺，在金属胎上将金属丝掐成各种花纹并焊好，然后把珐琅质的色釉填充在花纹内烧制成器。明清之际，景泰蓝工艺多用于从皇家到百姓的各类生活器具之中，但用于铜镜十分少见。现有的景泰蓝铜镜多见于清宫内府的官造器物中，富贵华丽，艳彩照人。
");
                                    isFirst[7] = false;
                                    break;
                                  case 8:
                                    alert("清仿和镜
年代：清
这枚仿和镜的镜背上有兰、松枝、奇石，上方为一“寶”字。印钮纹出自明代万历年间，而主纹是日本和镜制式，因此此镜属于改良式和镜，其山水纹、柳树纹和水仙纹均为日本和镜常见的图案。
");
                                    isFirst[8] = false;
                                    break;
                                }
